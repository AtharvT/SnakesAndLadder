...
class SnakesAndLadderBoardTest {
    ...
    void setUp() throws InvalidGameElementException {
        ...
        config.setSnakeList(List.of(new Snake(14, 7)));
        config.setLadderList(List.of(new Ladder(4, 25)));
        board = new SnakesAndLadderBoard(config);
    }

    @Test
    void testBoardInitialization() {
        Assertions.assertEquals(100, board.getSize(), "Board size should match configuration.");
